...
export default function HomePage({ initialDashboard }: HomePageProps) {
  ...
  return (
    <div className={styles.page}>
      ...
      <section className={styles.section}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle}>서울 최고가 실거래 단지 TOP 4</h2>
        </div>
        {isLoading ? (
      ...
      <section className={styles.section}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle}>강남구 최근 실거래</h2>
      ...
      <section className={styles.section}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle}>마포구 최근 실거래</h2>
      ...
      <section className={styles.section}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle}>용산구 최근 실거래</h2>
